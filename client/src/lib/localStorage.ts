...
export class LocalStorageService {
  ...
  async createTechnician(technician: InsertTechnician): Promise<Technician> {
    ...
    const newTech: Technician = {
      ...
      verificationStatus: technician.verificationStatus || "unverified",
      emergencyAvailable: technician.emergencyAvailable || false,
      subscriptionTier: technician.subscriptionTier || "free",
      subscriptionExpiresAt: technician.subscriptionExpiresAt || null,
      leadsUsedThisMonth: technician.leadsUsedThisMonth || 0,
      leadsResetAt: technician.leadsResetAt || null,
  ...
  async createPayment(payment: InsertPayment): Promise<Payment> {
    ...
    const newPayment: Payment = {
      ...
      escrowStatus: payment.escrowStatus || "pending",
